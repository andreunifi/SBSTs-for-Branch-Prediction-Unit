...
+sv +notimingchecks +define+ZOIX +define+TOPLEVEL=wallypipelinedcore +suppress+cell +delay_mode_fault +verbose+undriven -l zoix_compile.log


#2 step, simulation:

./zoix.sim +vcd+file+"${WALLY}/sim/${LOGIC_SIMULATOR}/core_rtl.vcd" \
 +vcd+dut+wallypipelinedcore+testbench.dut.core +vcd+verify +vcd+verbose  -l logic_sim.log +vcd+limit+mismatch+100000
